...
function getRootPath() {
    ...
    if (parent[1] == "level2" || parent[1] == "blogmgr")
        return "../../";
    else if (parent[0] == "index.html" && parent[1] != "blog" && parent[1] != "about" && parent[1] != "learning" && parent[1] != "perfect_life" && parent[1] != "user")
        return "./"
    else
        return "../"
}
...
function getuser(user) {
    return JSON.parse(storage_get(user));
}
